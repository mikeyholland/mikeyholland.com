...
export default function Video({ video }: { video: videoType }) {
  ...
  return (
    ...
    >
      <div className="relative bg-eerieBlack md:min-w-24 h-36 xs:h-44 md:h-64 lg:h-72 xl:h-88 2xl:h-96 flex items-center">
        <MuxPlayer
          ...
          className={clsx(
            ...
            'w-full h-36 xs:h-44 md:h-64 lg:h-72 xl:h-88 2xl:h-96',
          )}
        />
      </div>
    </div>
